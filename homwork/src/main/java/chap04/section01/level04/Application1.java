...
public class Application1 {
    public static void main(String[] args) {
        ...
        double avg = 0;
        boolean checkKor, checkEng, checkMath;
        ...
        checkKor = checkScore(kor);
        checkEng = checkScore(eng);
        checkMath = checkScore(math);

        if (avg >= 60 && checkKor && checkEng && checkMath){
            System.out.println("합격입니다!");
        } else {
            if (avg < 60) System.out.println("평균 점수 미달로 불합격입니다.");
            if (!checkKor) System.out.println("국어 점수 미달로 불합격입니다.");
            if (!checkEng) System.out.println("영어 점수 미달로 불합격입니다.");
            if (!checkMath) System.out.println("수학 점수 미달로 불합격입니다.");
        }
